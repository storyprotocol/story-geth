...
|   `evm`    | Developer utility version of the [EVM (Ethereum Virtual Machine)](https://ethereum.org/en/developers/docs/evm/) that is capable of running bytecode snippets within a configurable environment and execution mode. Its purpose is to allow isolated, fine-grained debugging of EVM opcodes (e.g. `evm --code 60ff60ff --debug run`).                                                                                                                                                                                                                                               |
